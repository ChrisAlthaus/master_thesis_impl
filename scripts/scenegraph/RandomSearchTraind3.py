...
_VAL_PERIOD = 25000 #* scalefactor
_CPKT_PERIOD = 25000 #* scalefactor
...
for i in range(0, _NUMRUNS):   
    ...
    configfile = '/home/althausc/master_thesis_impl/Scene-Graph-Benchmark.pytorch/configs/e2e_relation_X_101_32_8_FPN_1x.yaml' 
                #'/home/althausc/master_thesis_impl/Scene-Graph-Benchmark.pytorch/configs/e2e_relation_R_101_FPN_1x.yaml' 
    ...
    params = {'datasetselect': _DATASET_SELECT, 
			...
			'testbatchsize': _NUMGPUS, #to prevent assertion error
