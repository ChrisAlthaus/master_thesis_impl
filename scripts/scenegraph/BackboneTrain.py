...
_LR = 0.001/2#0.0025 #original: 0.001
_IMS_PER_BATCH = 8/2
_MAX_ITER = 50000
_STEPS = (30000, 45000)
_VAL_PERIOD = 2000
...
cmd = ("sbatch -w devbox4 -J {} -o {} "+ \
	...
	"OUTPUT_DIR {}")\
		.format(jobname, logfile, gpu_cmd, masterport, int(_IMS_PER_BATCH), _LR, _MAX_ITER, _VAL_PERIOD, _CPKT_PERIOD, _DATASET_SELECT, out_dir)
print(cmd)
os.system(cmd)
time.sleep(10)