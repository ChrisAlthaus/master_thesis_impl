#Path: /home/althausc/master_thesis_impl/Scene-Graph-Benchmark.pytorch/maskrcnn_benchmark/config/defaults.py
...
#modified: added
_C.DATASETS.SELECT = "default"
_C.DATASETS.VAL2 = ()
_C.SOLVER.IMG_AUGM_LOGPERIOD = 10000
_C.MODEL.RESUME_TRAIN = False
_C.TEST.POSTPROCESSING = CN()
_C.TEST.POSTPROCESSING.TOPKBOXES = 10
_C.TEST.POSTPROCESSING.TOPKRELS = 20
_C.TEST.POSTPROCESSING.TRESHBOXES = 0.001 #disabled
_C.TEST.POSTPROCESSING.TRESHRELS = 0.001 #disabled
#modified end
