...
class DefaultPredictor:
    ...
    def __call__(self, original_image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            inputs = {"image": image, "height": torch.as_tensor(height), "width": torch.as_tensor(width)}
            print([inputs])
            print(image.shape)
            writer = SummaryWriter('/home/althausc/master_thesis_impl/detectron2/out/checkpoints')
